...
<!-- default badges end -->
# DataGrid with WebAPI

In this example you can see how to configure the DataGrid component to work with remote WebAPI data service and Drill Down features.
